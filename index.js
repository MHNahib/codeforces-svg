...
const app = express();
app.use(cors());
const { uppercaseFirstLetter } = require("./src/utils");
...
//         ? response?.data?.result[0]?.maxRating
//         : "N/A";

//       let rank = response?.data?.result[0]?.rank
//         ? uppercaseFirstLetter(response?.data?.result[0]?.rank)
//         : "N/A";

//       let maxRank = response?.data?.result[0]?.maxRank
//         ? uppercaseFirstLetter(response?.data?.result[0]?.maxRank)
//         : "N/A";

//       let country = response?.data?.result[0]?.country
//         ? response?.data?.result[0]?.country
//         : "N/A";

//       let city = response?.data?.result[0]?.city
...
//         }
//         to {
//           stroke-dashoffset: 126.8848731681505;
//         }
//       }
...
//           class="header"
//           data-testid="header"
//         >${nameOrRating}'s GitHub Stats</text>
//       </g>
//         </g>
...
//         <text class="stat  bold" x="25" y="12.5">Max rating:</text>
//         <text
//           class="stat  bold"
//           x="190"
//           y="12.5"
...
//         <text class="stat  bold" x="25" y="12.5">Rank:</text>
//         <text
//           class="stat  bold"
//           x="190"
//           y="12.5"
...
//         <text class="stat  bold" x="25" y="12.5">Max Rank:</text>
//         <text
//           class="stat  bold"
//           x="190"
//           y="12.5"
...
//         <text class="stat  bold" x="25" y="12.5">City:</text>
//         <text
//           class="stat  bold"
//           x="190"
//           y="12.5"
...
//         <text class="stat  bold" x="25" y="12.5">Country:</text>
//         <text
//           class="stat  bold"
//           x="190"
//           y="12.5"
